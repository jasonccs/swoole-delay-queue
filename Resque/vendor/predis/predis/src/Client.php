...
/**
 * ClientInterface class used for connecting and executing commands on Redis.
 *
...
class Client implements ClientInterface, \IteratorAggregate
{
     ...
     *
     * @param mixed $options ClientInterface options.
     *
     ...
     * Closes the underlying connection and disconnects from the server.
     *
     * This is the same as `ClientInterface::disconnect()` as it does not actually send
