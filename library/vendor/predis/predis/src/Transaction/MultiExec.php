...
/**
 * ClientInterface-side abstraction of a Redis transaction based on MULTI / EXEC.
 *
 * {@inheritdoc}
 *
...
class MultiExec implements ClientContextInterface
{
    ...
    /**
     * @param ClientInterface $client  ClientInterface instance used by the transaction.
     ...
     *
     * @param ClientInterface $client ClientInterface instance used by the transaction object.
     *
    ...
    /**
     * Env method for protocol errors encountered inside the transaction.
     *
    ...
    private function onProtocolError($message)
    {
        ...
        // connections we can safely assume that Predis\ClientInterface::getConnection()
